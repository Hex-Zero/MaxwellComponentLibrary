...
export const AsLink: Story = { args: { asLink: true, href: 'https://example.com', children: 'External Link', variant: 'outline' } };
...
export const NewSizes: Story = { render: (args) => (
  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
    {(['2xs','xs','sm','md','lg','xl'] as const).map(s => <Button key={s} {...args} size={s}>{s}</Button>)}
  </div>
